...
>>>>>>> origin/master
	...
	auto _soldier1 = new Soldier(eStatus::RUNNING, GVector2(100, 300), 1);
	_soldier1->init();
	...
	auto fifleman1 = new Rifleman(eStatus::NORMAL, WINDOW_WIDTH / 2 + 100, WINDOW_HEIGHT / 2);
	fifleman1->init();
	_listobject.push_back(fifleman1);
<<<<<<< HEAD
	auto fifleman3 = new Rifleman(eStatus::HIDDEN, 400, 250);
	fifleman3->init();
	_listobject.push_back(fifleman3);
	auto wallTurret = new WallTurret(eStatus::NORMAL, GVector2(600, 150));
	wallTurret->init();
	_listobject.push_back(wallTurret);
	auto wallTurret1 = new WallTurret(eStatus::NORMAL, GVector2(800, 200));
	wallTurret1->init();
	_listobject.push_back(wallTurret1);
=======
